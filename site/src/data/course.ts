...
const meta: Record<string, Omit<Lab, "sourcePath" | "excerpt" | "html" | "headings">> = {
  ...
  "lab-16-console-ui": {
    ...
    number: 16,
    title: "Console UI",
    topic: "Spectre.Console: таблиці, панелі, дерево, меню",
    status: "ready",
    module: "Console UI",
    branch: "feature/console-ui",
    merge: "main",
  ...
  "lab-17-ef-basic": {
    ...
    topic: "DbContext, migrations, Code-First, seeding",
    status: "ready",
    module: "EF Core",
    branch: "feature/ef-core",
    merge: "feature/ef-core",
  ...
  "lab-18-ef-relations": {
    ...
    topic: "Navigation properties, Include, TPH",
    status: "ready",
    module: "EF Core",
    branch: "feature/ef-core",
    merge: "feature/ef-core",
  ...
  "lab-19-ef-advanced": {
    ...
    topic: "OwnsOne, TPH, RowVersion, concurrency",
    status: "ready",
    module: "EF Core",
    branch: "feature/ef-core",
    merge: "feature/ef-core",
  ...
  "lab-20-ef-queries": {
    ...
    topic: "IQueryable, pagination, DTO projections",
    status: "ready",
    module: "EF Core",
    branch: "feature/ef-core",
    merge: "main",
  ...
  "lab-21-async": {
    ...
    number: 21,
    title: "Async / Await",
    topic: "async/await, Task.WhenAll, CancellationToken, IProgress<T>",
    status: "ready",
    module: "Async",
  ...
  "lab-22-solid-di": {
    ...
    number: 22,
    title: "SOLID + DI",
    topic: "SOLID принципи, Strategy, Decorator, IServiceCollection",
    status: "ready",
    module: "Architecture",
    branch: "feature/solid-di",
    merge: "main",
...
export const courseStats = {
  title: "OOP C# Course",
  subtitle: "Курс, в рамках якого здійснюється розбудова консольної системи медичної клініки. Кожна практика — це невелика частина великого консольного проєкту",
  totalLabs: 22,
