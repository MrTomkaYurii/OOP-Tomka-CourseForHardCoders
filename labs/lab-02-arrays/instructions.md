...
Це стан гілки `main` перед початком роботи. Проєкт `Lab01/` лишився на гілці `Lab-01` і в `main` не потрапив, тому тут його немає:
...
**Легенда:** 🆕 — новий файл · ✏ — змінено вміст · Т*n* — номер задачі, у якій ви працюєте з файлом · Крок *n* — підготовчий крок на початку лаби.

Зверніть увагу: `Lab01/` тут немає — вона на своїй гілці `Lab-01`. Проєкт `Lab02/` існує лише на гілці `Lab-02`.
...
Пройдіться по всіх 8 завданнях, міняючи виклик у `Lab02/Program.cs`.
