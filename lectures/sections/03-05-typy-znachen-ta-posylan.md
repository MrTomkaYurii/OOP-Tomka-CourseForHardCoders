...
![Кадри методів Main і Calculate у стеку](_assets/_docx/image46.png)
...
![Посилання зі стеку на об'єкт у купі](_assets/_docx/image47.png)
...
![Структура у стеку і об'єкт класу в купі](_assets/_docx/image48.png)
...
![Поле посилального типу всередині структури](_assets/_docx/image49.png)
...
![Дві структури з посиланням на один об'єкт у купі](_assets/_docx/image50.png)
