...
![Клас Patient як шаблон та два об'єкти-екземпляри](_assets/03-classes/class-vs-object.png)
...
![Стек зберігає посилання, купа — самі об'єкти](_assets/03-classes/stack-heap.png)
...
![Дві змінні — одне посилання на один об'єкт](_assets/03-classes/reference-semantics.png)
